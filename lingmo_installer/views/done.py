...
from lingmo_installer.windows.dialog_output import LingmoDialogOutput


@Gtk.Template(resource_path="/org/lingmoos/Installer/gtk/done.ui")
class LingmoDone(Adw.Bin):
    __gtype_name__ = "LingmoDone"
    ...
    def __on_log_clicked(self, button):
        if self.__terminal:
            dialog = LingmoDialogOutput(self.__window, self.__terminal)
            dialog.present()
