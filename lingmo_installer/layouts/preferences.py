...
from lingmo_installer.windows.dialog import LingmoDialog


@Gtk.Template(resource_path="/org/lingmoos/Installer/gtk/layout-preferences.ui")
class LingmoLayoutPreferences(Adw.Bin):
    __gtype_name__ = "LingmoLayoutPreferences"
