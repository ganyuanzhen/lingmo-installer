...
from lingmo_installer.core.disks import DisksManager, Diskutils, Partition
from lingmo_installer.core.system import Systeminfo


@Gtk.Template(resource_path="/org/lingmoos/Installer/gtk/widget-disk.ui")
class LingmoDefaultDiskEntry(Adw.ActionRow):
    __gtype_name__ = "LingmoDefaultDiskEntry"
...
@Gtk.Template(resource_path="/org/lingmoos/Installer/gtk/widget-partition-row.ui")
...
@Gtk.Template(resource_path="/org/lingmoos/Installer/gtk/widget-partition.ui")
...
@Gtk.Template(resource_path="/org/lingmoos/Installer/gtk/dialog-disk.ui")
class LingmoDefaultDiskPartModal(Adw.Window):
    __gtype_name__ = "LingmoDefaultDiskPartModal"
    __gsignals__ = {
...
@Gtk.Template(resource_path="/org/lingmoos/Installer/gtk/dialog-disk-confirm.ui")
class LingmoDefaultDiskConfirmModal(Adw.Window):
    __gtype_name__ = "LingmoDefaultDiskConfirmModal"
...
@Gtk.Template(resource_path="/org/lingmoos/Installer/gtk/default-disk.ui")
class LingmoDefaultDisk(Adw.Bin):
    __gtype_name__ = "LingmoDefaultDisk"
    ...
    def __init__(self, window, distro_info, key, step, **kwargs):
        ...
        for disk in self.__disks.all_disks:
            entry = LingmoDefaultDiskEntry(self, disk)
    ...
    def __on_auto_clicked(self, button):
        ...
        modal = LingmoDefaultDiskConfirmModal(self.__window, self.__partition_recipe)
        modal.present()

    def __on_manual_clicked(self, button):
        modal = LingmoDefaultDiskPartModal(self.__window, self, self.__selected_disks)
