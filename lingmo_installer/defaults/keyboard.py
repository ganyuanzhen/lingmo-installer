...
from lingmo_installer.core.keymaps import KeyMaps

@Gtk.Template(resource_path="/org/lingmoos/Installer/gtk/widget-keyboard.ui")
...
@Gtk.Template(resource_path="/org/lingmoos/Installer/gtk/default-keyboard.ui")
class LingmoDefaultKeyboard(Adw.Bin):
    __gtype_name__ = "LingmoDefaultKeyboard"
