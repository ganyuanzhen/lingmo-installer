...
logger = logging.getLogger("LingmoInstaller::Conn_Check")


@Gtk.Template(resource_path="/org/lingmoos/Installer/gtk/default-conn-check.ui")
class LingmoDefaultConnCheck(Adw.Bin):
    __gtype_name__ = "LingmoDefaultConnCheck"
