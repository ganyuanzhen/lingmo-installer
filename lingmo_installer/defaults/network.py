...
logger = logging.getLogger("LingmoInstaller::Network")
...
@Gtk.Template(resource_path="/org/lingmoos/Installer/gtk/wireless-row.ui")
...
@Gtk.Template(resource_path="/org/lingmoos/Installer/gtk/default-network.ui")
class LingmoDefaultNetwork(Adw.Bin):
    __gtype_name__ = "LingmoDefaultNetwork"
