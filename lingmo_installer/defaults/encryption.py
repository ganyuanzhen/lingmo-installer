...
@Gtk.Template(resource_path="/org/lingmoos/Installer/gtk/default-encryption.ui")
class LingmoDefaultEncryption(Adw.Bin):
    __gtype_name__ = "LingmoDefaultEncryption"
