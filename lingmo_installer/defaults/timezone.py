...
from lingmo_installer.core.timezones import (
    all_timezones,
    get_location,
    get_timezone_preview,
)
from lingmo_installer.utils.run_async import RunAsync


@Gtk.Template(resource_path="/org/lingmoos/Installer/gtk/widget-timezone.ui")
...
@Gtk.Template(resource_path="/org/lingmoos/Installer/gtk/default-timezone.ui")
class LingmoDefaultTimezone(Adw.Bin):
    __gtype_name__ = "LingmoDefaultTimezone"
