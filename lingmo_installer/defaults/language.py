...
from lingmo_installer.core.languages import all_languages, current_language


@Gtk.Template(resource_path="/org/lingmoos/Installer/gtk/widget-language.ui")
...
@Gtk.Template(resource_path="/org/lingmoos/Installer/gtk/default-language.ui")
class LingmoDefaultLanguage(Adw.Bin):
    __gtype_name__ = "LingmoDefaultLanguage"
