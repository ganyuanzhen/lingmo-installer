...
@Gtk.Template(resource_path="/org/lingmoos/Installer/gtk/window-ram.ui")
class LingmoRamWindow(Adw.Window):
    __gtype_name__ = "LingmoRamWindow"
    ...
    def __continue(self, btn):
        subprocess.Popen("IGNORE_RAM=1 lingmo-installer", shell=True)
        sys.exit(0)
