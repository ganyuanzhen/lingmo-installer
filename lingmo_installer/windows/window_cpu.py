...
@Gtk.Template(resource_path="/org/lingmoos/Installer/gtk/window-cpu.ui")
class LingmoCpuWindow(Adw.Window):
    __gtype_name__ = "LingmoCpuWindow"
    ...
    def __continue(self, btn):
        subprocess.Popen("IGNORE_RAM=1 IGNORE_CPU=1 lingmo-installer", shell=True)
        sys.exit(0)
