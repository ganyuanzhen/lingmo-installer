...
@Gtk.Template(resource_path="/org/lingmoos/Installer/gtk/window-unsupported.ui")
class LingmoUnsupportedWindow(Adw.Window):
    __gtype_name__ = "LingmoUnsupportedWindow"
